...
public class SeasonRecyclerViewAdapterOld extends RecyclerView.Adapter<SeasonRecyclerViewAdapterOld.ViewHolder> {
    ...
    public SeasonRecyclerViewAdapterOld(Context context, List<Episode> episodes) {
